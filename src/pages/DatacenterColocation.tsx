...
// Datacentre Colocation Services data
const serviceData = {
  icon: Database,
  ...
  features: [
    {
      icon: Server,
      title: "Flexible Colocation Options",
      description: "Choose from quarter rack to full cage solutions with scalable infrastructure that grows with your business needs. Private suites available for enterprise deployments."
    },
    {
      icon: Zap,
      title: "Redundant Power Systems",
      description: "N+1 redundant power infrastructure with UPS systems, backup generators, and diverse utility feeds ensuring continuous operations during any power event."
    },
    {
      icon: Thermometer,
      title: "Advanced Cooling Solutions",
      description: "Precision environmental controls with hot/cold aisle containment, in-row cooling, and 24/7 monitoring maintaining optimal temperature and humidity levels."
    },
    {
      icon: Lock,
      title: "Multi-Layer Security",
      description: "Biometric access control, 24/7 security personnel, video surveillance, mantrap entry systems, and comprehensive visitor management protocols."
    },
    {
      icon: Activity,
      title: "Carrier-Neutral Connectivity",
      description: "Direct access to multiple Tier 1 carriers, internet exchanges, and cloud on-ramps with diverse fiber entry points for optimal connectivity options."
    },
    {
      icon: Shield,
      title: "Compliance & Certifications",
      description: "SOC 2 Type II, ISO 27001, PCI-DSS, HIPAA compliant facilities with regular audits and comprehensive compliance documentation for regulated industries."
    }
  ],
  ...
  process: [
    {
      ...
      description: "Comprehensive evaluation of your infrastructure requirements including power density, cooling needs, connectivity requirements, and compliance obligations. Site tours and capacity planning included."
    },
    {
      step: "02",
      title: "Design & Configuration",
      description: "Custom cabinet layouts, power distribution design, network connectivity planning, and security access setup. Detailed implementation plan with migration timeline and risk mitigation."
    },
    {
      step: "03",
      title: "Migration & Deployment",
      description: "Professional equipment installation with minimal downtime. Coordinated logistics, careful equipment handling, cable management, and comprehensive testing of all systems."
    },
    {
      step: "04",
      title: "Ongoing Management",
      description: "Continuous monitoring, remote hands support, scheduled maintenance, capacity management, and regular reporting. Dedicated account management and technical support team."
    }
  ],
  ...
  caseStudies: [
    ...
    },
    {
      ...
      result: "50% infrastructure cost cut",
  ...
  solutions: [
    {
      name: "Quarter Rack",
      description: "Ideal for startups and small deployments with 10U space",
      specs: "2kW power, 1Gbps connectivity"
    },
    {
      name: "Half Rack",
      description: "Perfect for growing businesses needing 20U capacity",
      specs: "4kW power, 10Gbps connectivity"
    },
    {
      name: "Full Rack",
      description: "Complete 42U cabinet for comprehensive deployments",
      specs: "8kW power, 10Gbps+ connectivity"
    },
    {
      name: "Private Cage",
      description: "Dedicated secure space for multiple racks and equipment",
      specs: "Custom power, dedicated cross-connects"
    },
    {
      name: "Private Suite",
      description: "Exclusive data center floor space for enterprise needs",
      specs: "Scalable power density, private entrance"
    },
    {
      name: "Disaster Recovery",
      description: "Geographically distributed colocation for business continuity",
      specs: "Multi-site redundancy, sync services"
    }
  ]
};
  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-20">
      ...
      <section className="relative py-16 sm:py-20 md:py-24 overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-20" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center border border-cyan-500/30">
            ...
            <p className="text-xl sm:text-2xl text-cyan-400 font-medium mb-6 sm:mb-8">
              {serviceData.tagline}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-cyan-500/50 hover:scale-105 transition-all duration-300">
                Schedule Tour
            ...
            {serviceData.highlights.map((item, index) => {
              ...
              return (
                <div key={index} className="text-center">
                  <HighlightIcon className="w-8 h-8 text-cyan-400 mx-auto mb-3" />
          ...
          {activeTab === 'overview' && (
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-8 sm:mb-12">
                World-Class Colocation Infrastructure
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {serviceData.features.map((feature, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="absolute -inset-0.5 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-2xl opacity-0 group-hover:opacity-100 blur transition duration-500" />
                      <div className="relative bg-slate-900 rounded-2xl p-6">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center border border-cyan-500/30 mb-4">
                  ...
                  >
                    ...
                    <div className="relative bg-slate-900 rounded-2xl p-6">
                      ...
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-cyan-500/10 border border-cyan-500/30 rounded-lg">
                        ...
                        <span className="text-xs text-cyan-300 font-semibold">{solution.specs}</span>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-800 p-8 sm:p-12">
                <div className="flex flex-wrap gap-4 mb-12">
                  {serviceData.technologies.map((tech, index) => (
                    <span
                      key={index}
                      className="px-6 py-3 bg-slate-800/50 text-slate-300 rounded-xl border border-slate-700/50 font-medium hover:border-cyan-500/50 hover:text-cyan-400 transition-all duration-300"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg text-slate-400 max-w-2xl mx-auto">
              Trusted by leading enterprises for mission-critical infrastructure hosting
            </p>
          </div>
                ...
                <div className="relative bg-slate-900 rounded-2xl overflow-hidden">
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-xs text-cyan-400 uppercase tracking-wide font-semibold">
                        {study.industry}
                      </span>
                    </div>
                    ...
                    <button className="text-sm text-cyan-400 hover:text-cyan-300 transition-colors flex items-center gap-2 font-semibold">
                      Read Case Study
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-400">
              Meeting the highest industry standards for security and reliability
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl sm:text-5xl font-bold text-cyan-400 mb-2">Tier III+</div>
              <div className="text-slate-400">Data Center Tier</div>
            </div>
            <div className="text-center">
              <div className="text-4xl sm:text-5xl font-bold text-cyan-400 mb-2">SOC 2</div>
              <div className="text-slate-400">Type II Certified</div>
            </div>
            <div className="text-center">
              <div className="text-4xl sm:text-5xl font-bold text-cyan-400 mb-2">ISO 27001</div>
              <div className="text-slate-400">Information Security</div>
            </div>
            <div className="text-center">
              <div className="text-4xl sm:text-5xl font-bold text-cyan-400 mb-2">PCI-DSS</div>
              <div className="text-slate-400">Payment Compliant</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative p-12 sm:p-16 lg:p-20 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-cyan-600 font-semibold rounded-xl hover:shadow-2xl hover:scale-105 transition-all duration-300">
