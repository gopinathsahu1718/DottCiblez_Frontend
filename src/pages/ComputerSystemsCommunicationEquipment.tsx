  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-20">
      ...
      <section className="relative py-16 sm:py-20 md:py-24 overflow-hidden">
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-indigo-950/50 via-slate-950 to-blue-950/50" />
        <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-indigo-500/20 to-blue-500/20 flex items-center justify-center border border-indigo-500/30">
            ...
            <p className="text-xl sm:text-2xl text-indigo-400 font-medium mb-6 sm:mb-8">
              {serviceData.tagline}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-indigo-600 to-blue-600 text-white font-semibold rounded-xl hover:shadow-2xl hover:shadow-indigo-500/50 hover:scale-105 transition-all duration-300">
            ...
            {serviceData.highlights.map((item, index) => {
              ...
              return (
                <div key={index} className="text-center">
                  <HighlightIcon className="w-8 h-8 text-indigo-400 mx-auto mb-3" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {serviceData.features.map((feature, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="absolute -inset-0.5 bg-gradient-to-r from-indigo-500 to-blue-600 rounded-2xl opacity-0 group-hover:opacity-100 blur transition duration-500" />
                      <div className="relative bg-slate-900 rounded-2xl p-6">
                        <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-500/20 to-blue-500/20 flex items-center justify-center border border-indigo-500/30 mb-4">
                  ...
                  >
                    ...
                    <div className="relative bg-slate-900 rounded-2xl p-6">
                      ...
                      <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-500/10 border border-indigo-500/30 rounded-lg">
                        ...
                        <span className="text-xs text-indigo-300 font-semibold">{solution.specs}</span>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-800 p-8 sm:p-12">
                <div className="flex flex-wrap gap-4 mb-12">
                  {serviceData.technologies.map((tech, index) => (
                    <span
                      key={index}
                      className="px-6 py-3 bg-slate-800/50 text-slate-300 rounded-xl border border-slate-700/50 font-medium hover:border-indigo-500/50 hover:text-indigo-400 transition-all duration-300"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="relative bg-slate-900 rounded-2xl overflow-hidden">
                  ...
                  <div className="p-6">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-xs text-indigo-400 uppercase tracking-wide font-semibold">
                        {study.industry}
                      </span>
                    </div>
                    ...
                    <button className="text-sm text-indigo-400 hover:text-indigo-300 transition-colors flex items-center gap-2 font-semibold">
                      Read Case Study
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl sm:text-5xl font-bold text-indigo-400 mb-2">99.99%</div>
              <div className="text-slate-400">Uptime SLA</div>
            </div>
            <div className="text-center">
              <div className="text-4xl sm:text-5xl font-bold text-indigo-400 mb-2">&lt;15min</div>
              <div className="text-slate-400">Response Time</div>
            </div>
            <div className="text-center">
              <div className="text-4xl sm:text-5xl font-bold text-indigo-400 mb-2">24/7/365</div>
              <div className="text-slate-400">Support Coverage</div>
            </div>
            <div className="text-center">
              <div className="text-4xl sm:text-5xl font-bold text-indigo-400 mb-2">10+ Years</div>
          ...
          <div className="relative rounded-3xl overflow-hidden">
            ...
            <div className="relative p-12 sm:p-16 lg:p-20 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-white text-indigo-600 font-semibold rounded-xl hover:shadow-2xl hover:scale-105 transition-all duration-300">
